...
src/
  rank_market_cap_ratio.py [588L] -> src.company_config, src.company_metadata_fallback, src.schema, src.browser, src.utils
  ...
  utils.py [50L] (ensure_dir, open_csv, validate_url_not_private)
...
scripts/
  ...
  validate_ocr_accuracy.py [174L] -> src.pdf_extract, src.utils
...
class FacilityLand @src/pdf_extract.py:16 <-src/cache.py, src/company_config.py, run.py
...
class BrowserServiceError @src/browser.py:79 <-run.py, src/company_metadata_fallback.py, src/web_address_research.py, scripts/populate_company_master.py
class WebAddressResearcher @src/web_address_research.py:41 <-run.py
...
fn extract_major_facilities_land @src/pdf_extract.py:388 <-run.py, scripts/validate_ocr_accuracy.py
fn batch_extract_facilities @src/pdf_extract.py:486 <-run.py
...
fn urlopen_with_retry @src/network.py:27
fn open_csv @src/utils.py:20 <-run.py, src/rank_market_cap_ratio.py, scripts/validate_ocr_accuracy.py
fn validate_url_not_private @src/utils.py:36 <-src/company_metadata_fallback.py, src/web_address_research.py, src/web_cache.py
...
fn _infer_landuse_family @run.py:776 <-run.py (equipment_type→用途ファミリー推定, _EQUIPMENT_FAMILY_MAP参照)
fn generate_ranking @src/rank_market_cap_ratio.py:541 <-run.py
...
src.rank_market_cap_ratio -> {src.company_config, src.company_metadata_fallback, src.schema, src.browser, src.utils}
...
scripts.validate_ocr_accuracy -> {src.pdf_extract, src.utils}
