...
logger: logging.Logger = logging.getLogger("land_value_research.browser")
    ...
    def fetch(
        ...
        *,
        ...
        Args:
            ...
            proxy: Proxy URL (``http://host:port`` etc).  Omit for direct connection.
        ...
        effective_timeout: int = timeout if timeout is not None else int(MAGIC["browser"]["page_timeout"])
